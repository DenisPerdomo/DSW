...
<div class="card card-body bg-light mt-5">
    <h3>Borrar Puesto</h3>
    <form action="<?php echo RUTA_URL;?>stations/delete/<?php echo $data['id']?>" method="POST">
        ...
        <div class="form-group">
            <label for="idSede">Departamento</label>
            <input type="text" class="form-control" name="office" value = "<?php echo $data['department_name'];?>" id="idSede" aria-describedby="sedeHelp" disabled">
        </div>
