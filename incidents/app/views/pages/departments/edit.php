...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo RUTA_URL;?>departments/edit/<?php echo $data['id']?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="office" value = "<?php echo $data['office'];?>" id="idSede" aria-describedby="sedeHelp" placeholder="Añade la sede">
        </div>
