             ...
             <div class="card-body">
                <form action="" method="post" enctype=”multipart/form-data”>
                    ...
                    <div class="form-group">
                       ...
                       <input type="text" name="clientName" id="clientNameId" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name = "clientDate" id="clientDateId" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="clientEmailId">Email</label>
                       <input type="email" name = "clientEmail" id="clientEmailId" class="form-control">
                    </div>
